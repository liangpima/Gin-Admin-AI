    ...
    "paths": {
        ...
        "/captcha/verify": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "验证码 token 与点击坐标",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.CaptchaVerifyRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/pay/notify/wechat": {
            "post": {
                "description": "由微信支付平台发起，**自行验签、不做登录鉴权**；请求体是渠道原始报文。\n响应为 ` + "`" + `{\"code\":\"SUCCESS\"}` + "`" + ` 或 ` + "`" + `{\"code\":\"FAIL\",\"message\":\"处理失败\"}` + "`" + `，\n不是统一 Response 结构（渠道侧只认它自己的约定）。",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/system/config/batch": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "键值对列表，元素形如 {key, value}",
                        "name": "items",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateDictDataRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/system/dict/data/{id}": {
            "put": {
                ...
                "parameters": [
                    {
                        "description": "字典项信息（含 id）",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateDictDataRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateDictTypeRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/system/dict/type/{id}": {
            "put": {
                ...
                "parameters": [
                    {
                        "description": "字典类型信息（含 id）",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateDictTypeRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/system/pay/order": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "微信 openid（JSAPI 支付需要）",
                        "name": "openId",
                        "in": "body",
                        "schema": {
                            "type": "string"
